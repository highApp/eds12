...
class NewCategoryScreen extends StatefulWidget {
  String employerId = "";
  late VoidCallback catAdded;
  NewCategoryScreen({required this.employerId, required this.catAdded});
...
class _NewCategoryScreenState extends State<NewCategoryScreen> {
  ...
  final txtCategoryName = TextEditingController();

  _btnActionAddCat(BuildContext context) {
  ...
  _callAddNewCategory(BuildContext context) {
    ...
    body['name'] = txtCategoryName.text;
